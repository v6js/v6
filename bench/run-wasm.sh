...
for name in fib primes wasi_io memcpy_bulk table_dispatch dotproduct quicksort; do
...
for name in fib primes memcpy_bulk table_dispatch dotproduct quicksort; do
