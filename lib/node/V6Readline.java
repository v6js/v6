  ...
  public static V6Object build() {
    ...
    o.set("createInterface", fn((thisArg, args) -> {
            ...
            V6Callable onData = (t, a) -> {
              ...
              String chunk = chunkVal.tag() == V6Value.TAG_OBJ &&
                      chunkVal.ref() instanceof V6Buffer
                  ? V6BufferConstructor.encodeBytes(((V6Buffer)chunkVal.ref()).toBytes(),
                                                    "utf8")
                  : chunkVal.toString();
              ...
              while ((idx = pending.indexOf("\n")) >= 0) {
                ...
                if (qcb != null)
                  ...
                  rl.get("emit").asCallable().call(objValue(rl),
                                                   new V6Value[] {str("line"), str(line)});
              }
              return UNDEF;
            };
            V6Value setEncodingFn = fInput.getProp("setEncoding");
            if (setEncodingFn.tag() == V6Value.TAG_FUNC)
              setEncodingFn.asCallable().call(fInput, new V6Value[] {str("utf8")});

            fInput.getProp("on").asCallable().call(fInput,
                                                    new V6Value[] {str("data"), fn(onData)});
            ...
            rl.set("question", fn((t, a) -> {
                    ...
                    if (fOutput.tag() == V6Value.TAG_OBJ) {
                      ...
                      if (writeFn.tag() == V6Value.TAG_FUNC)
                        writeFn.asCallable().call(fOutput, new V6Value[] {str(query)});
                    }
                    if (cb != null)
