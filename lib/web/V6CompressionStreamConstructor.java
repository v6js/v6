...
public final class V6CompressionStreamConstructor
  ...
  public V6Value construct(V6Value[] args) {
    ...
    transformer.set("flush", fn((t, a) -> {
                      ...
                      switch (format) {
                      case "gzip":
                        output = V6Zlib.gzipBytes(input);
                        break;
                      case "deflate-raw":
                        output = V6Zlib.deflateBytes(input, true);
                        break;
                      default:
                        output = V6Zlib.deflateBytes(input, false);
                        break;
                      }
