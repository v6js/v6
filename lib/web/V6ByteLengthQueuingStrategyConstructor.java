public final class V6ByteLengthQueuingStrategyConstructor
  ...
  public V6Value construct(V6Value[] args) {
    ...
    self.set("size", fn((t, a) -> {
               V6Value chunk = V6Value.argAt(a, 0);
               if (chunk.tag() == V6Value.TAG_OBJ && chunk.ref() instanceof
                                                         V6Object) {
                 V6Value len = ((V6Object)chunk.ref()).get("byteLength");
                 if (!len.isUndefined())
                   return num(len.toNumber());
                 len = ((V6Object)chunk.ref()).get("length");
                 if (!len.isUndefined())
                   return num(len.toNumber());
               }
               return num(0);
