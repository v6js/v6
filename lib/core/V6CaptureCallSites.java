public final class V6CaptureCallSites {
  ...
  public static V6Array captureCallSites(int skip) {
    java.util.List<StackWalker.StackFrame> frames =
        StackWalker.getInstance().walk(
            s
            -> s.skip(skip).limit(32).collect(
  ...
  public static final V6Value CAPTURE_CALL_SITES =
      fn((thisArg, args) -> objValue(captureCallSites(1)));
}
