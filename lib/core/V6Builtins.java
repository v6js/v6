public final class V6Builtins {
  ...
  private static V6Object arrayPrototype() {
    ...
    o.set("some", fn((thisArg, args)
                         -> boolValue(asObj(thisArg).some(
                             V6Value.argAt(args, 0).asCallable()))));
    o.set("every", fn((thisArg, args)
                          -> boolValue(asObj(thisArg).every(
                              V6Value.argAt(args, 0).asCallable()))));
    o.set(
        "find",
        fn((thisArg,
            args) -> asObj(thisArg).find(V6Value.argAt(args, 0).asCallable())));
    o.set("findIndex",
          fn((thisArg, args)
                 -> new V6Value(V6Value.TAG_NUM,
                                asObj(thisArg).findIndex(
                                    V6Value.argAt(args, 0).asCallable()),
                                null)));
  ...
  public static V6Value GLOBAL_OBJECT = objValue(new V6Object());

  public static void resetGlobalObject() {
    GLOBAL_OBJECT = objValue(new V6Object());
  }

  public static final V6Value NODE_ASSERT =
      new V6Value(V6Value.TAG_FUNC, 0, V6Assert.build());
  public static final V6Value NODE_QUERYSTRING =
      objValue(V6QueryString.build());
  ...
  private static V6Value buildUrlModule() {
    ...
    o.set("parse", fn((thisArg, args) -> V6UrlLegacy.parseImpl(args)));
    o.set("format", fn((thisArg, args) -> V6UrlLegacy.formatImpl(args)));
    o.set("resolve", fn((thisArg, args) -> V6UrlLegacy.resolveImpl(args)));
    return objValue(o);
  }
